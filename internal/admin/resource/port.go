...
// 初始化
func (p *Port) Init(ctx *builder.Context) interface{} {
	// 标题
	p.Title = "港口"
	// 模型
	p.Model = &model.Port{}
...
func (p *Port) Fields(ctx *builder.Context) []interface{} {
...
// 搜索
func (p *Port) Searches(ctx *builder.Context) []interface{} {
...
// 行为
func (p *Port) Actions(ctx *builder.Context) []interface{} {
	return []interface{}{
		actions.CreateLink(),
		actions.BatchDelete(),
