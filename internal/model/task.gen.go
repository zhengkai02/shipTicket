...
type Task struct {
	...
	PassengerNum     int32       `gorm:"column:passenger_num;type:int(8)" json:"passenger_num"`
	VehicleNum       int32       `gorm:"column:vehicle_num;type:int(8)" json:"vehicle_num"`
	Status           int32      `gorm:"column:status;type:tinyint(1);not null" json:"status"`
