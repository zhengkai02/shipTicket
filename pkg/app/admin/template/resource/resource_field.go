...
// ID组件
//
// field.ID("id", "ID") 或 field.ID("id", "ID", func() api{} { return p.Field["username"] })
...
// Hidden组件
//
// field.Hidden("id", "ID") 或 field.Hidden("id", "ID", func() api{} { return p.Field["username"] })
...
// 输入框组件
//
// field.Text("username", "输入框") 或 field.Text("username", "输入框", func() api{} { return p.Field["username"] })
...
// 文本域组件
//
// field.TextArea("name", "文本域") 或 field.TextArea("name", "文本域", func() api{} { return p.Field["name"] })
...
// 密码组件
//
// field.Password("name", "密码框") 或 field.Password("name", "密码", func() api{} { return p.Field["name"] })
...
// 单选组件
//
// field.Radio("name", "单选") 或 field.Radio("name", "单选", func() api{} { return p.Field["name"] })
...
// 多选组件
//
// field.Checkbox("name", "多选") 或 field.Checkbox("name", "多选", func() api{} { return p.Field["name"] })
...
// 日期组件
//
// field.Date("name", "日期") 或 field.Date("name", "日期", func() api{} { return p.Field["name"] })
...
// 日期范围组件
//
// field.DateRange("name", "日期范围") 或 field.DateRange("name", "日期范围", func() api{} { return p.Field["name"] })
...
// 日期时间组件
//
// field.Datetime("name", "日期时间") 或 field.Datetime("name", "日期时间", func() api{} { return p.Field["name"] })
...
// 日期时间范围组件
//
// field.DatetimeRange("name", "日期时间范围") 或 field.DatetimeRange("name", "日期时间范围", func() api{} { return p.Field["name"] })
...
// 开关组件
//
// field.Switch("name", "开关") 或 field.Switch("name", "开关", func() api{} { return p.Field["name"] })
...
// 树形组件
//
// field.Tree("name", "树形组件") 或 field.Tree("name", "树形组件", func() api{} { return p.Field["name"] })
...
// 图标组件
//
// field.Icon("name", "图标") 或 field.Icon("name", "图标", func() api{} { return p.Field["name"] })
...
// 下拉框组件
//
// field.Select("name", "文本") 或 field.Select("name", "文本", func() api{} { return p.Field["name"] })
...
// 级联菜单组件
//
// field.Cascader("name", "级联菜单") 或 field.Cascader("name", "级联菜单", func() api{} { return p.Field["name"] })
...
// 图片组件
//
// field.Image("name", "文本") 或 field.Image("name", "文本", func() api{} { return p.Field["name"] })
...
// 文件组件
//
// field.File("name", "文件") 或 field.File("name", "文件", func() api{} { return p.Field["name"] })
...
// 编辑器组件
//
// field.Editor("name", "编辑器") 或 field.Editor("name", "编辑器", func() api{} { return p.Field["name"] })
...
// 分组组件
//
// field.Group("分组组件",[]api{}{field.Text("title", "标题"),field.Number("num","奖品数量")})
...
// List组件
//
// field.List("name", "List") 或 field.List("name", "List", func() api{} { return p.Field["name"] })
...
// 地图组件
//
// field.Map("name", "地图") 或 field.Map("name", "地图", func() api{} { return p.Field["name"] })
...
// 地图围栏组件
//
// field.Geofence("name", "地图围栏") 或 field.Geofence("name", "地图围栏", func() api{} { return p.Field["name"] })
...
// 日期-月组件
//
// field.Month("name", "月") 或 field.Month("name", "月", func() api{} { return p.Field["name"] })
...
// 数字输入框组件
//
// field.Number("name", "数字") 或 field.Number("name", "数字", func() api{} { return p.Field["name"] })
...
// 日期-季度组件
//
// field.Quarter("name", "季度") 或 field.Quarter("name", "季度", func() api{} { return p.Field["name"] })
...
// 搜索组件
//
// field.Search("name", "搜索") 或 field.Search("name", "搜索", func() api{} { return p.Field["name"] })
...
// 时间范围组件
//
// field.TimeRange("name", "时间范围") 或 field.TimeRange("name", "时间范围", func() api{} { return p.Field["name"] })
...
// 时间组件
//
// field.Time("name", "时间") 或 field.Time("name", "时间", func() api{} { return p.Field["name"] })
...
// 周组件
//
// field.Week("name", "周") 或 field.Week("name", "周", func() api{} { return p.Field["name"] })
...
// 年组件
//
// field.Year("name", "年") 或 field.Year("name", "年", func() api{} { return p.Field["name"] })
...
// 树选择组件
//
// field.TreeSelect("name", "树选择") 或 field.TreeSelect("name", "树选择", func() api{} { return p.Field["name"] })
...
// 间距布局组件
//
// field.Space("间距组件",[]api{}{field.Text("title", "标题"),field.Number("num","奖品数量")})
...
// 紧凑布局组件
//
// field.Compact("紧凑布局",[]api{}{field.Text("title", "标题"),field.Number("num","奖品数量")})
...
// 录入结构化的一维数组数据
//
// field.FieldSet("name", "组件列表") 或 field.FieldSet("name", "组件列表", func() api{} { return p.Field["name"] })
